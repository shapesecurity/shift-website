...
function thunkify(reducer) {
  return {
    ...
    reduceBinaryExpression: function reduceBinaryExpression(node, _ref9) {
      var left = _ref9.left,
          right = _ref9.right;
    ...
    reduceBlockStatement: function reduceBlockStatement(node, _ref14) {
    ...
    reduceCallExpression: function reduceCallExpression(node, _ref15) {
      var callee = _ref15.callee,
          _arguments = _ref15.arguments;

      return reducer.reduceCallExpression(node, { callee: callee(), _arguments: _arguments.map(function (n) {
          return n();
        }) });
    },
    reduceCatchClause: function reduceCatchClause(node, _ref16) {
      var binding = _ref16.binding,
          body = _ref16.body;

      return reducer.reduceCatchClause(node, { binding: binding(), body: body() });
    },
    reduceClassDeclaration: function reduceClassDeclaration(node, _ref17) {
      var name = _ref17.name,
          _super = _ref17.super,
          elements = _ref17.elements;

      return reducer.reduceClassDeclaration(node, { name: name(), _super: _super == null ? null : _super(), elements: elements.map(function (n) {
          return n();
        }) });
    },
    reduceClassElement: function reduceClassElement(node, _ref18) {
      var method = _ref18.method;

      return reducer.reduceClassElement(node, { method: method() });
    },
    reduceClassExpression: function reduceClassExpression(node, _ref19) {
      var name = _ref19.name,
          _super = _ref19.super,
          elements = _ref19.elements;

      return reducer.reduceClassExpression(node, { name: name == null ? null : name(), _super: _super == null ? null : _super(), elements: elements.map(function (n) {
          return n();
        }) });
    },
    reduceCompoundAssignmentExpression: function reduceCompoundAssignmentExpression(node, _ref20) {
    ...
    reduceComputedMemberAssignmentTarget: function reduceComputedMemberAssignmentTarget(node, _ref21) {
    ...
    reduceComputedMemberExpression: function reduceComputedMemberExpression(node, _ref22) {
    ...
    reduceComputedPropertyName: function reduceComputedPropertyName(node, _ref23) {
      var expression = _ref23.expression;

      return reducer.reduceComputedPropertyName(node, { expression: expression() });
    },
    reduceConditionalExpression: function reduceConditionalExpression(node, _ref24) {
    ...
    reduceDataProperty: function reduceDataProperty(node, _ref25) {
    ...
    reduceDoWhileStatement: function reduceDoWhileStatement(node, _ref26) {
    ...
    reduceExport: function reduceExport(node, _ref27) {
    ...
    reduceExportDefault: function reduceExportDefault(node, _ref28) {
      var body = _ref28.body;

      return reducer.reduceExportDefault(node, { body: body() });
    },
    reduceExportFrom: function reduceExportFrom(node, _ref29) {
    ...
    reduceExportLocalSpecifier: function reduceExportLocalSpecifier(node, _ref30) {
      var name = _ref30.name;

      return reducer.reduceExportLocalSpecifier(node, { name: name() });
    },
    reduceExportLocals: function reduceExportLocals(node, _ref31) {
    ...
    reduceExpressionStatement: function reduceExpressionStatement(node, _ref32) {
      var expression = _ref32.expression;

      return reducer.reduceExpressionStatement(node, { expression: expression() });
    },
    reduceForInStatement: function reduceForInStatement(node, _ref33) {
    ...
    reduceForOfStatement: function reduceForOfStatement(node, _ref34) {
    ...
    reduceForStatement: function reduceForStatement(node, _ref35) {
    ...
    reduceFormalParameters: function reduceFormalParameters(node, _ref36) {
    ...
    reduceFunctionBody: function reduceFunctionBody(node, _ref37) {
    ...
    reduceFunctionDeclaration: function reduceFunctionDeclaration(node, _ref38) {
    ...
    reduceFunctionExpression: function reduceFunctionExpression(node, _ref39) {
    ...
    reduceGetter: function reduceGetter(node, _ref40) {
    ...
    reduceIfStatement: function reduceIfStatement(node, _ref41) {
    ...
    reduceImport: function reduceImport(node, _ref42) {
    ...
    reduceImportNamespace: function reduceImportNamespace(node, _ref43) {
    ...
    reduceImportSpecifier: function reduceImportSpecifier(node, _ref44) {
      var binding = _ref44.binding;

      return reducer.reduceImportSpecifier(node, { binding: binding() });
    },
    reduceLabeledStatement: function reduceLabeledStatement(node, _ref45) {
    ...
    reduceMethod: function reduceMethod(node, _ref46) {
    ...
    reduceModule: function reduceModule(node, _ref47) {
    ...
    reduceNewExpression: function reduceNewExpression(node, _ref48) {
      var callee = _ref48.callee,
          _arguments = _ref48.arguments;

      return reducer.reduceNewExpression(node, { callee: callee(), _arguments: _arguments.map(function (n) {
          return n();
        }) });
    },
    ...
    reduceObjectAssignmentTarget: function reduceObjectAssignmentTarget(node, _ref49) {
    ...
    reduceObjectBinding: function reduceObjectBinding(node, _ref50) {
    ...
    reduceObjectExpression: function reduceObjectExpression(node, _ref51) {
    ...
    reduceSetter: function reduceSetter(node, _ref54) {
    ...
    reduceShorthandProperty: function reduceShorthandProperty(node, _ref55) {
      var name = _ref55.name;

      return reducer.reduceShorthandProperty(node, { name: name() });
    },
    reduceSpreadElement: function reduceSpreadElement(node, _ref56) {
      var expression = _ref56.expression;

      return reducer.reduceSpreadElement(node, { expression: expression() });
    },
    reduceStaticMemberAssignmentTarget: function reduceStaticMemberAssignmentTarget(node, _ref57) {
      var object = _ref57.object;

      return reducer.reduceStaticMemberAssignmentTarget(node, { object: object() });
    },
    reduceStaticMemberExpression: function reduceStaticMemberExpression(node, _ref58) {
    ...
    reduceSwitchCase: function reduceSwitchCase(node, _ref59) {
    ...
    reduceSwitchDefault: function reduceSwitchDefault(node, _ref60) {
    ...
    reduceSwitchStatement: function reduceSwitchStatement(node, _ref61) {
    ...
    reduceSwitchStatementWithDefault: function reduceSwitchStatementWithDefault(node, _ref62) {
    ...
    reduceTemplateExpression: function reduceTemplateExpression(node, _ref63) {
      var tag = _ref63.tag,
    ...
    reduceThrowStatement: function reduceThrowStatement(node, _ref64) {
      var expression = _ref64.expression;

      return reducer.reduceThrowStatement(node, { expression: expression() });
    },
    reduceTryCatchStatement: function reduceTryCatchStatement(node, _ref65) {
    ...
    reduceTryFinallyStatement: function reduceTryFinallyStatement(node, _ref66) {
    ...
    reduceUnaryExpression: function reduceUnaryExpression(node, _ref67) {
      var operand = _ref67.operand;

      return reducer.reduceUnaryExpression(node, { operand: operand() });
    },
    reduceUpdateExpression: function reduceUpdateExpression(node, _ref68) {
      var operand = _ref68.operand;

      return reducer.reduceUpdateExpression(node, { operand: operand() });
    },
    reduceVariableDeclaration: function reduceVariableDeclaration(node, _ref69) {
