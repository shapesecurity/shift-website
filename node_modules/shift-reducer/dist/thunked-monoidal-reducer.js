...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Generated by generate-thunked-monoidal-reducer.js
/**
...
var MonoidalReducer = function () {
  function MonoidalReducer(monoid) {
    ...
    var combine = void 0;
    var combineThunked = monoid.prototype && monoid.prototype.concatThunk || monoid.concatThunk;
    if (typeof combineThunked === 'function') {
      combine = function combine(a, b) {
        return combineThunked.call(a, b);
      };
    } else {
      ...
      if (monoid.isAbsorbing) {
        ...
        combine = function combine(a, b) {
          return isAbsorbing(a) ? a : concat.call(a, b());
        };
      } else {
        combine = function combine(a, b) {
    ...
    this.append = function () {
      ...
      return args.reduce(combine, identity);
    };
  }
