...
(function (global) {
  ...
  require.define('/dist/index.js', function (module, exports, __dirname, __filename) {
    ...
    exports.CloneReducer = require('/dist/clone-reducer.js', module)['default'];
    exports.MonoidalReducer = require('/dist/monoidal-reducer.js', module)['default'];
  });
  require.define('/dist/monoidal-reducer.js', function (module, exports, __dirname, __filename) {
    'use strict';
  ...
  require.define('/dist/clone-reducer.js', function (module, exports, __dirname, __filename) {
    'use strict';
    var _classCallCheck = function (instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError('Cannot call a class as a function');
  ...
  global.reducer = require('/dist/index.js');
}.call(this, this));
